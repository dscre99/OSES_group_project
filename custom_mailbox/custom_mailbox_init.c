...
int custom_mailbox_init(void)
{
    ...
    err_control = rt_mb_init(&mb_main_speed,
                        "mb_main_speed",                            /* Name is mb_main_speed*/
                        &mb_main_speed_pool[0],                     /* The memory pool used by the mailbox is mb_main_speed_pool */
    ...
    err_control = rt_mb_init(&mb_main_throttle,
                        "mb_main_throttle",                         /* Name is mb_main_throttle*/
                        &mb_main_throttle_pool[0],                  /* The memory pool used by the mailbox is mb_main_throttle_pool */
    ...
    err_control = rt_mb_init(&mb_speed_display,
                        ...
                        &mb_speed_display_pool[0],                  /* The memory pool used by the mailbox is mb_speed_display_pool */
    ...
    err_control = rt_mb_init(&mb_throttle_display,
                        "mb_throttle_display",                      /* Name is mb_throttle_display*/
                        &mb_throttle_display_pool[0],               /* The memory pool used by the mailbox is mb_throttle_display_pool */
    ...
    err_control = rt_mb_init(&mb_mottemp_display,
                        ...
                        &mb_mottemp_display_pool,                   /* The memory pool used by the mailbox is mb_mottemp_display_pool */
    ...
    err_control = rt_mb_init(&mb_battemp_display,
                        ...
                        &mb_battemp_display_pool,                   /* The memory pool used by the mailbox is mb_battemp_display_pool */
    ...
    err_control = rt_mb_init(&mb_batlevel_display,
                        ...
                        &mb_batlevel_display_pool,                  /* The memory pool used by the mailbox is mb_batlevel_display_pool */
    ...
    err_control = rt_mb_init(&mb_brake_throttle,
                        ...
                        &mb_brake_throttle_pool[0],                 /* The memory pool used by the mailbox is mb_brake_throttle_pool */
    ...
    // initializes brake_detection-auxiliary_light_management mailbox
    err_control = rt_mb_init(&mb_brake_alman,
                        "mb_brake_alman",                           /* Name is mb_brake_alman*/
                        &mb_brake_alman_pool[0],                    /* The memory pool used by the mailbox is mb_brake_alman_pool */
    ...
    err_control = rt_mb_init(&mb_throttle_speed,
                        "mb_throttle_speed",                        /* Name is mb_throttle_speed*/
                        &mb_throttle_speed_pool,                    /* The memory pool used by the mailbox is mb_throttle_speed_pool */
    ...
    err_control = rt_mb_init(&mb_speed_throttle,
                        ...
                        &mb_speed_throttle_pool,                    /* The memory pool used by the mailbox is mb_speed_throttle_pool */
    ...
    err_control = rt_mb_init(&mb_alman_display,
                       "mb_alman_display",                          /* Name is mb_alman_display*/
                       &mb_alman_display_pool,                      /* The memory pool used by the mailbox is mb_alman_display_pool */
